...
Este manual define el estandar de revision para garantizar que cada linea de codigo respete la arquitectura Segi. El Code Reviewer es el ultimo filtro antes de que el codigo llegue a produccion.
