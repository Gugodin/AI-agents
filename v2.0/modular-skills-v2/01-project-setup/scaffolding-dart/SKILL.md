...
description: Reglas para la creacion del esqueleto del proyecto basado en la arquitectura Segi, incluyendo manejo de ambientes.
---

# Skill: Scaffolding Dart - Estructura Segi Architecture
...
```text
lib/
├── app/                 # Widget raiz de la aplicacion (segi_app.dart)
...
## 5. Archivos Base de la Arquitectura
...
4. **lib/app/segi_app.dart**: Widget base que inyecta los temas y rutas globales.
...
1. **Fidelidad Visual**: El Auditor debe comparar la estructura creada contra la imagen de referencia de la Arquitectura Segi. Cualquier carpeta faltante (como `gen/` o `injector/dependencies/`) se marca como ERROR.
